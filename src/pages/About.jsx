                        ...
                        <div>
                            <div className='flex flex-col md:flex-row justify-between gap-3'>
                                ...
                                <div className='w-full md:w-1/2'>
                                    ...
                                    <p>
                                        <span className='font-semibold text-base'># </span>Take of Programming Contest DIU <span className='font-semibold'>Ranking 11th </span>
                                        (12/2021) <Link to='https://toph.co/c/diu-take-off-2021/standings' target="_blank" className='text-blue-500'>Link......</Link>
                                    </p>
                                    <p>
                                        <span className='font-semibold text-base'># </span>Take of Programming Contest DIU <span className='font-semibold'>Ranking 96th </span>
